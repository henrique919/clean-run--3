...
export function buildDemoSeedItems(): Item[] {
  return [
    ...
    makeSeed({ id: "demo-def-coastline-jura", code: "DEF-010", type: "defect", status: "issued", project: "Jura Noosa", building: "Block B", level: "L02", unit: "B-204", room: "Bedroom 2", trade: "Painting", subcontractor: "Coastline Painting", priority: "high", dueDays: 3, createdDaysAgo: 4, issuedDaysAgo: 3, description: "Paint scuff to robe return wall. Patch, sand and touch up to match surrounding finish.", photos: [["Paint Scuff", 310]] }),
    makeSeed({ id: "demo-inc-complete-jura", code: "INC-003", type: "incomplete", status: "complete", project: "Jura Noosa", building: "Block B", level: "L01", unit: "B-112", room: "Bathroom", trade: "Electrical", subcontractor: "Northline Electrical", priority: "high", dueDays: -1, createdDaysAgo: 8, issuedDaysAgo: 7, inProgressDaysAgo: 6, readyDaysAgo: 2, inspectionStartedDaysAgo: 1, acceptedDaysAgo: 1, closedDaysAgo: 1, description: "Mirror cabinet LED driver label missing. Label installed and checked during inspection.", closeout: [{ by: "Site Manager", role: "Site Manager", note: "Completed without photo evidence.", confirmation: "I confirm this item has been inspected and is acceptable for closeout.", daysAgo: 1 }] }),
  ];
}
